                ...
                <div class="stage">
                    ...
                    <div class="cbImage active signin agileits" style="width:600px;">
                        ...
                        <table id="table_users" class="display" style="width:100%">
                            ...
                            List<Enseignant> listEns = ens.ListEnseignants();
                            for(Enseignant en : listEns) {
                                out.print("<tr>"
                                    + "<td>"+en.getNom()+"</td>"
                                    + "<td>"+en.getPrenom()+"</td>"
                                    + "<td>"+en.getGrade()+"</td>"
                                    + "<td><a href=ModifierEnseignant.jsp?id="+en.getId()+">Modifier</a></td>"
                                    + "<td><a href=SupprimerEnseignantServlet?id="+en.getId()+">Supprimer</a></td>"
                                + "</tr>");
                            }
                            %>
                            </tbody>
